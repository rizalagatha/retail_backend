    ...
    try {
        ...
        if (isNew) {
            ...
            await connection.query(insertHeaderQuery, [
                ...
                header.customer.kode, header.customer.level.split(' - ')[0], footer.pinTanpaDp, header.keterangan, aktifStatus, header.salesCounter, user.kode
            ]);
        } else {
            ...
            await connection.query(updateHeaderQuery, [
                header.customer.kode, header.penawaran, header.customer.level.split(' - ')[0], header.tanggal, header.dateline, header.top || 0, header.ppnPersen || 0, footer.pinTanpaDp, header.keterangan,
