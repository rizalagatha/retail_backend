...
const loadInitialData = async (tanggal, user) => {
  ...
  const detail1Query = `
         -- A. SETORAN KASIR TUNAI (FULL DARI TSETOR_HDR)
        SELECT 
  ...
  // [PERBAIKAN] SETORAN KASIR TUNAI SEKARANG AMBIL DARI tsetor_hdr JUGA
  const detail2Query = `
  ...
  // Parameter array disesuaikan jumlahnya menjadi 5 pasang
