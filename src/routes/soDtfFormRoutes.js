...
router.get(
  ...
  soDtfFormController.searchSales,
);
router.get(
  "/search/jenis-order",
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.searchJenisOrder,
);
router.get(
  "/search/jenis-kain",
  verifyToken,
  soDtfFormController.searchJenisKain,
);
router.get(
  "/search/workshop",
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.searchWorkshop,
);
...
router.get(
  ...
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.getUkuranKaos,
);
router.get(
  "/lookup/ukuran-sodtf-detail",
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.getUkuranSodtfDetail,
);
router.get(
  "/lookup/size-cetak",
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.getSizeCetak,
);
...
router.get(
  ...
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.searchSoForDtf,
);
...
router.get(
  ...
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.getSisaKuota,
);
router.post(
  "/calculate-dtg-price",
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.calculateDtgPrice,
);
...
router.get(
  ...
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.getPrintData,
);
...
router.post(
  ...
  soDtfFormController.create,
);
router.put(
  "/:nomor",
  verifyToken,
  checkPermission(MENU_ID, "edit"),
  soDtfFormController.update,
);
...
router.get(
  ...
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soDtfFormController.getSoDetailForDtf,
);
