...
router.get(
  ...
  soFormController.searchPenawaran,
);
router.get(
  "/lookup/penawaran-details/:nomor",
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soFormController.getPenawaranDetails,
);
router.get(
  "/lookup/default-discount",
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soFormController.getDefaultDiscount,
);
router.get(
  "/lookup/jenis-order",
  verifyToken,
...
router.post(
  ...
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soFormController.hitungHarga,
);
router.post(
  "/hitung-harga-custom",
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soFormController.calculateHargaCustom,
);
...
router.get(
  ...
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soFormController.searchSetoran,
);
router.get(
  "/lookup/rekening",
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soFormController.searchRekening,
);
...
router.get(
  ...
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soFormController.getDpPrintData,
);
...
router.get(
  ...
  verifyToken,
  checkPermission(MENU_ID, "view"),
  soFormController.checkLhkStatus,
);
