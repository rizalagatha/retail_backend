...
router.get('/search/so', verifyToken, checkPermission(MENU_ID, 'view'), controller.searchSo);

// Memuat detail item dari SO yang dipilih
router.get('/load-from-so/:nomorSo', verifyToken, checkPermission(MENU_ID, 'view'), controller.loadFromSo);
...
// Memuat data Mutasi Stok yang sudah ada untuk mode "Ubah"
