...
router.get('/export-header', verifyToken, checkPermission(MENU_ID, 'view'), soDtfController.exportHeader);

router.get('/export-detail', verifyToken, checkPermission(MENU_ID, 'view'), soDtfController.exportDetail);
