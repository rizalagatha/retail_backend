...
const manifestKirimRoutes = require("./routes/manifestKirimRoutes");
...
const biayaKirimRoutes = require("./routes/biayaKirimRoutes");
const biayaKirimFormRoutes = require("./routes/biayaKirimFormRoutes");
...
app.use("/api/ai", clientCertAuth, aiRoutes);
...
app.use("/api/katalog", clientCertAuth, katalogRoutes);
...
app.use("/api/manifest-kirim", clientCertAuth, manifestKirimRoutes);
...
app.use("/api/biaya-kirim", clientCertAuth, biayaKirimRoutes);
app.use("/api/biaya-kirim-form", clientCertAuth, biayaKirimFormRoutes);
app.use("/api/hrd", clientCertAuth, hrdRoutes);
...
app.use("/api/peminjaman-barang", clientCertAuth, peminjamanRoutes);
app.use("/api/peminjaman-barang-form", clientCertAuth, peminjamanFormRoutes);
app.use(
