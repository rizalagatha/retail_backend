...
app.use("/api/jenis-kain", jenisKainRoutes);
app.use("/api/warna-kain", warnaKainRoutes);
app.use("/api/lengan", lenganRoutes);
app.use("/api/barang-dc", barangDcRoutes);
app.use("/api/barang-dc-form", barangDcFormRoutes);
app.use("/api/price-list", priceListRoutes);
app.use("/api/promo", promoRoutes);
app.use("/api/promo-form", promoFormRoutes);
app.use("/api/terima-stbj", terimaStbjRoutes);
app.use("/api/terima-stbj-form", terimaStbjFormRoutes);
app.use("/api/tolak-stbj-form", tolakStbjFormRoutes);
app.use('/api/terima-repair', terimaRepairRoutes);
app.use('/api/terima-repair-form', terimaRepairFormRoutes);
app.use("/api/ambil-barang", ambilBarangRoutes);
app.use("/api/ambil-barang-form", ambilBarangFormRoutes);
